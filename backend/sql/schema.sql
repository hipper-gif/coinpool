...
CREATE TABLE IF NOT EXISTS `rank_conditions` (
    ...
    `min_investment`          DECIMAL(15,2) NOT NULL COMMENT 'インフィニティ最低本人運用額',
    `min_direct_referrals`    INT           NOT NULL COMMENT 'インフィニティ最低直紹介人数',
    `min_group_investment`    DECIMAL(15,2) NOT NULL COMMENT 'インフィニティ最低グループ運用額',
    `mm_min_investment`       DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'メガマッチ最低本人運用額',
    `mm_min_direct_referrals` INT           NOT NULL DEFAULT 0    COMMENT 'メガマッチ最低直紹介人数',
    `mm_min_group_investment` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'メガマッチ最低グループ運用額',
...
VALUES
    ('bronze',    5000.00,  1,   100000.00,  10000.00,  1,   150000.00, 0.50, 0.50, 0.50,  2.00,  1.00, NOW()),
    ('silver',   10000.00,  3,   300000.00,  20000.00,  3,   500000.00, 1.00, 1.00, 0.75,  3.00,  2.00, NOW()),
    ('gold',     25000.00,  5,  1000000.00,  50000.00,  5,  1500000.00, 1.50, 1.50, 1.00,  5.00,  3.50, NOW()),
    ('platinum', 50000.00,  7,  3000000.00,  75000.00,  7,  5000000.00, 2.00, 2.00, 1.50,  7.50,  6.00, NOW()),
    ('diamond', 100000.00, 10,  5000000.00, 150000.00, 10,  7500000.00, 3.00, 3.00, 0.00, 12.50,  7.50, NOW());
...
-- -------------------------------------------------------------
-- root user
-- Original password: Coinpool2525
-- Hash generated by PHP: password_hash('Coinpool2525', PASSWORD_BCRYPT)
-- NOTE: 以下のハッシュはプレースホルダーです。
--       実際のハッシュはサーバー上で PHP の password_hash() を使って生成してください。
-- -------------------------------------------------------------
INSERT INTO `users`
    (`name`, `email`, `password`, `role`, `referrer_id`, `investment_amount`, `rank`, `created_at`, `updated_at`)
VALUES
